...
import { exportSecureStorage, secureStorage } from './secureStorage.js'
  ...
  return (
    <div className="generated-image-card">
      <a href={source} target="_blank" rel="noreferrer" className="generated-image-link" title="Open full-size image">
        <img src={source} alt={prompt || 'Generated by Athena'} />
      </a>
...
function App({ currentUsername, currentRole, currentRoleTone, canViewVeniceBalance, onLogout, onChangePassword }) {
  ...
  useEffect(() => {
    secureStorage.setItem(STORAGE_KEY, JSON.stringify(conversations))
  }, [conversations])
